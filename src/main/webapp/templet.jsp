...
<body>
	<div id="wrapper">
		...
		<p style="font-size: 1.3em; line-height: 1.5; margin: 1em 0;">
			This page demonstrates a Metro UI inspired jQuery UI theme built with
			the jQUIT Builder. More info can be found at <a
				href="http://jquit.com">jquit.com</a>.
		</p>
		...
		<div>
			<input id="autocomplete" style="z-index: 100; position: relative"
				title="type &quot;a&quot;" />
		</div>
